...
(144, 'Volvo Model Replicas, Co', 'Berglund', 'Christina', '0921-12 3555', 'Berguvsv�gen 8', NULL, 'Lule�', NULL, 'S-958 22', 'Sweden', 1504, CAST(53100.00 AS DECIMAL(10,2))),  
(145, 'Danish Wholesale Imports', 'Peterson', 'Jytte', '+45 32 21 3555', 'Vinb�ltet 34', NULL, 'Kobenhavn', NULL, '1734', 'Denmark', 1504, CAST(93400.00 AS DECIMAL(10,2))),  
...
(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da sa�de n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL, CAST(0.00 AS DECIMAL(10,2))),
(171,'Daedalus Designs Imports','Ranc�','Martine ','20.16.1555','184, chauss�e de Tournai',NULL,'Lille',NULL,'59000','France',1370, CAST(82900.00 AS DECIMAL(10,2)));
...
(209,'Mini Caravy','Citeaux','Fr�d�rique ','88.60.1555','24, place Kl�ber',NULL,'Strasbourg',NULL,'67000','France',1370, CAST(53800.00 AS DECIMAL(10,2))),
...
(216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Catalu�a, 23',NULL,'Barcelona',NULL,'08022','Spain',1702, CAST(60300.00 AS DECIMAL(10,2))),

(219,'Boards & Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166, CAST(11000.00 AS DECIMAL(10,2))),

(223,'Nat�rlich Autos','Kloss','Horst ','0372-555188','Taucherstra�e 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),

(227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'�rhus',NULL,'8200','Denmark',1401, CAST(120800.00 AS DECIMAL(10,2))),

(233,'Qu�bec Home Shopping Network','Fresni�re','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montr�al','Qu�bec','H1J 1C3','Canada',1286, CAST(48700.00 AS DECIMAL(10,2))),

(237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran V�a, 1',NULL,'Madrid',NULL,'28001','Spain',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(256,'Auto Associ�s & Cie.','Tonini','Daniel ','30 59 8555','67, avenue de l\','Europe','Versailles',NULL,'78000','France',1370, CAST(77900.00 AS DECIMAL(10,2))),
(259,'Toms Spezialit�ten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'K�ln',NULL,'50739','Germany',1504, CAST(120400.00 AS DECIMAL(10,2))),
...
(273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'M�nchen',NULL,'80805','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'Gen�ve',NULL,'1203','Switzerland',1702, CAST(141300.00 AS DECIMAL(10,2))),
...
(335,'Cramer Spezialit�ten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'M�nster',NULL,'44087','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(409,'Stuttgart Collectable Exchange','M�ller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','�kergatan 24',NULL,'Br�cke',NULL,'S-844 67','Sweden',1504, CAST(116400.00 AS DECIMAL(10,2))),
...
(458,'Corrida Auto Replicas, Ltd','Sommer','Mart�n ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702, CAST(104600.00 AS DECIMAL(10,2))),
...
(477,'Mit Vergn�gen & Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL, CAST(0.00 AS DECIMAL(10,2))),
...
(484,'Iberia Gift Imports, Corp.','Roel','Jos� Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702, CAST(65700.00 AS DECIMAL(10,2))),
